...
authorsRouter.post('/add', function (req, res) {
    ...
    var item={
        ...
        image:req.body.image, //PART#2 - Point8 images is changed to image
...
authorsRouter.post('/delete', function (req, res) { //part#2 - point9 delete is a proper method for delete operation than post
...
authorsRouter.post('/update', function (req, res) { //part#2 - point9 put is a proper method for update operation than post
